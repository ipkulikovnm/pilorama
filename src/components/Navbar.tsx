      ...
      <div className="container-custom">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            >
              <span
                className={isScrolled ? "text-green-700" : "text-green-100"}
              >
                Лес
              </span>
              <span className={isScrolled ? "text-brown-700" : "text-white"}>
                Мастер
              </span>
            </a>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-md overflow-hidden transform scale-0 group-hover:scale-100 transition-transform duration-300 origin-top">
                <a
                  href="#plywood"
                  className="block px-4 py-2 text-sm hover:bg-brown-50 font-medium text-green-700"
                >
                  Фанера
                </a>
                <a
                  href="#lumber"
                  className="block px-4 py-2 text-sm hover:bg-brown-50"
                >
                  Пиломатериалы
                </a>
                <a
      ...
      >
        <div className="container-custom py-4">
          <nav className="flex flex-col space-y-4">
            <a href="#products" className="nav-link py-2">
              Продукция
            </a>
            <a
              href="#plywood"
            ...
            <a href="#lumber" className="nav-link py-2 pl-4">
              - Пиломатериалы
            </a>
            <a href="#hardwood" className="nav-link py-2 pl-4">
              - Твёрдая древесина
            </a>
            <a href="#softwood" className="nav-link py-2 pl-4">
              - Мягкая древесина
            </a>
            <a href="#about" className="nav-link py-2">
              О нас
            </a>
            <a href="#testimonials" className="nav-link py-2">
              Отзывы
            </a>
